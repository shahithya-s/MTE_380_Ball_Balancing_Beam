...
class SimpleAutoCalibrator:
    ...
    def __init__(self):
        ...
        self.BEAM_LENGTH_M = 0.139  # Known beam length in meters
        ...
        self.servo_port = "/dev/cu.usbmodem11401"  # Servo communication port
    ...
    def send_servo_angle(self, angle):
        ...
        if self.servo:
            angle = int(np.clip(angle, 125, 155))   # safety clip
            cmd = f"{angle}\n"                   # e.g. "15\n"
